	...
	return (
		<div className="flex items-center space-x-2 pr-1">
			<input
				...
				className="flex-1 p-2 focus:outline-none text-zinc-950 dark:text-zinc-200 bg-white dark:bg-neutral-900"
				maxLength={69}
			/>
			{chat.draftMessage && (
				<div className="flex items-center h-full border-l border-zinc-300 dark:border-zinc-700 pl-1">
					<button
						...
						dark:bg-white dark:text-black hover:bg-blue-500 dark:hover:bg-blue-500"
					>
						<FaArrowUp size={22} />
					</button>
				</div>
